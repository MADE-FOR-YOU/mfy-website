      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-2 mb-6">
             <Link to="/"><img src={logo} alt="logo" className="w-8 h-8 bg-neutral rounded flex items-center justify-center font-bold text-primary"/> </Link> 
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://www.instagram.com/madee4rryouu?igsh=MTk0MXh2bTQ0OTVzbA==" className="p-2 bg-white/5 rounded-full hover:bg-white/10 transition-colors text-white/70 hover:text-white"><Instagram size={20} /></a>
              <a href="https://www.tiktok.com/@madee4rryouu?_r=1&_t=ZM-92ZjY0vfvvI" className="p-2 bg-white/5 rounded-full hover:bg-white/10 transition-colors text-white/70 hover:text-white"><FontAwesomeIcon icon={faTiktok} size="lg" /></a>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-white/40 text-xs">
          ...
          <div className="flex gap-6">
            <Link to="/privacy" className="hover:text-white transition-colors">{t('privacy_policy')}</Link>
            <Link to="/terms" className="hover:text-white transition-colors">{t('terms_of_service')}</Link>
          </div>
        </div>
      </div>
    </footer>
